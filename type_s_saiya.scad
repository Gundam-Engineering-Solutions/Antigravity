...
// Component: 360-Segment Electret Hull Assembly

// --- Global Parameters ---
ship_radius = 500;      // Total radius of the ship
hub_radius = 100;       // Central cockpit/avionics hub radius
...
// 1. Ventral (Bottom) Plates - Negative Charge
color("silver") 
full_ring_assembly();
